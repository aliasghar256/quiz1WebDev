...
export const list = [
  ...
  {
    id: 2,
    cover: "../images/list/DamacElo2.jpg",
    name: "ELO2 - Damac",
    location: "Madinat Hind 4 - Damac Hills, Dubai, United Arab Emirates",
    category: "For Sale",
    price: "9,750",
    type: "Apartments",
    currency: "AED",
...
export const location = [
  {
    ...
    Offices: "07 Offices",
    cover: "./images/location/DubaiMarina.webp",
  },
  {
    id: 2,
    name: "Mohammed Bin Rashid City (MBR), Dubai",
    Villas: "12 Villas",
    Apartments: "10 Apartments",
    Offices: "07 Offices",
    cover: "./images/location/mbrcity.jpg",
  },
  {
    id: 3,
...
export const projects = [
  {
    id: 1,
    image: "../images/list/HillmontEllington.jpg",
    name: "Hillmont Residencies",
